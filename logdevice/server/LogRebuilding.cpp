...
bool LogRebuilding::RebuildingReadFilter::
...
bool LogRebuilding::RebuildingReadFilter::shouldProcessTimeRange(
    RecordTimestamp min,
    RecordTimestamp max) {
 ...
 */
void LogRebuilding::RebuildingReadFilter::noteRecordFiltered(
