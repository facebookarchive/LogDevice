...
enum class DonorProgressFlags : uint8_t {
  NewToOld = 1,
  NONE = 0
};
DEFINE_BITMASK_OPERATORS(DonorProgressFlags, uint8_t)

inline const char **EnumNamesDonorProgressFlags() {
  static const char *names[] = { "NewToOld", nullptr };
  return names;
}

inline const char *EnumNameDonorProgressFlags(DonorProgressFlags e) { return EnumNamesDonorProgressFlags()[static_cast<int>(e) - static_cast<int>(DonorProgressFlags::NewToOld)]; }
...
struct DonorProgress FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table {
  ...
  DonorProgressFlags flags() const { return static_cast<DonorProgressFlags>(GetField<uint8_t>(VT_FLAGS, 0)); }
  bool Verify(flatbuffers::Verifier &verifier) const {
    return VerifyTableStart(verifier) &&
           VerifyField<uint64_t>(verifier, VT_IDX) &&
...
struct DonorProgressBuilder {
  ...
  void add_flags(DonorProgressFlags flags) { fbb_.AddElement<uint8_t>(DonorProgress::VT_FLAGS, static_cast<uint8_t>(flags), 0); }
  ...
  flatbuffers::Offset<DonorProgress> Finish() {
    auto o = flatbuffers::Offset<DonorProgress>(fbb_.EndTable(start_, 3));
    return o;
  }
};
...
inline flatbuffers::Offset<DonorProgress> CreateDonorProgress(flatbuffers::FlatBufferBuilder &_fbb,
    uint64_t idx = 0,
    uint64_t ts = 0,
    DonorProgressFlags flags = static_cast<DonorProgressFlags>(0)) {
...
struct ShardInfo FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table {
  ...
  bool filter_relocate_shards() const { return GetField<uint8_t>(VT_FILTER_RELOCATE_SHARDS, 0) != 0; }
  bool Verify(flatbuffers::Verifier &verifier) const {
    return VerifyTableStart(verifier) &&
           VerifyField<uint64_t>(verifier, VT_IDX) &&
           VerifyField<uint64_t>(verifier, VT_VERSION) &&
...
struct ShardInfoBuilder {
  ...
  void add_filter_relocate_shards(bool filter_relocate_shards) { fbb_.AddElement<uint8_t>(ShardInfo::VT_FILTER_RELOCATE_SHARDS, static_cast<uint8_t>(filter_relocate_shards), 0); }
...
inline flatbuffers::Offset<ShardInfo> CreateShardInfoDirect(flatbuffers::FlatBufferBuilder &_fbb,
    ...
    bool filter_relocate_shards = false) {
  return CreateShardInfo(_fbb, idx, version, nodes ? _fbb.CreateVector<flatbuffers::Offset<NodeInfo>>(*nodes) : 0, donor_progress ? _fbb.CreateVector<flatbuffers::Offset<DonorProgress>>(*donor_progress) : 0, filter_relocate_shards);
}
